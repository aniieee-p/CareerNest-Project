                    ...
                    <div className='flex flex-col gap-4'>
                        {savedJobs.map(job => (
                            <div
                                ...
                                className='p-4 sm:p-5 rounded-xl shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer'
                                style={{ background: "var(--cn-card)", border: "1px solid var(--cn-border)" }}
                            >
                                <div className='flex flex-col sm:flex-row sm:items-start justify-between gap-3 sm:gap-4'>
                                    <div className='flex items-center gap-3 sm:gap-4 min-w-0'>
                                        <Avatar className="h-10 w-10 sm:h-12 sm:w-12 shrink-0" style={{ border: "1px solid var(--cn-border)" }}>
                                        ...
                                        <div className="min-w-0">
                                            <h2 className='font-bold truncate' style={{ color: "var(--cn-text-1)" }}>{job?.title}</h2>
                                            <p className='text-sm' style={{ color: "var(--cn-text-2)" }}>{job?.company?.name}</p>
                                            <div className='flex flex-wrap items-center gap-2 sm:gap-3 mt-1 text-xs' style={{ color: "var(--cn-text-3)" }}>
